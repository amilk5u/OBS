...
(function (objSimulator) {
	...
	var configData = { //환경 설정값 저장, JSON 정상 로딩 시 override 됨
		...
		backgroundImages: [
			//@2022-06-10 배경-A 숨김처리 (s)
			/*{
				name: 'modern',
				images: ['bg_modern_01.png', 'bg_modern_02.png', 'bg_modern_03.png', 'bg_modern_04.png']
			},
			{
				name: 'nature',
				images: ['bg_nature_01.png', 'bg_nature_02.png', 'bg_nature_03.png', 'bg_nature_04.png']
			},
			{
				name: 'nordic',
				images: ['bg_nordic_01.png', 'bg_nordic_02.png', 'bg_nordic_03.png', 'bg_nordic_04.png']
			}*/

			{
				name: 'modern',
				images: ['bg_modern_B_01.png', 'bg_modern_B_02.png', 'bg_modern_B_03.png', 'bg_modern_B_04.png']
			},
			{
				name: 'nature',
				images: ['bg_nature_B_01.png', 'bg_nature_B_02.png', 'bg_nature_B_03.png', 'bg_nature_B_04.png']
			},
			{
				name: 'nordic',
				images: ['bg_nordic_B_01.png', 'bg_nordic_B_02.png', 'bg_nordic_B_03.png', 'bg_nordic_B_04.png']
			}
			//@2022-06-10 배경-A 숨김처리 (e)
		],
		object: [
			{
				id: 'refrigerator',
				...
				supportedSurface: [   //지원 가능한 색상 정보, sidebar 에서 활용
                    ...
                    /**/{
						name: "<span class='lang_kz'>Тұтас металл</span><span class='lang_ru'>Цельнометаллический</span>",
						colors: [
							{ name: '<span class="lang_kz">күңгірт қара</span><span class="lang_ru">матово-черный</span>', colorChip: 'color_02st_black.png', colorCode: 'st_black' },
							{ name: '<span class="lang_kz">күміс түстес</span><span class="lang_ru">серебристый</span>', colorChip: 'color_02st_silver.png', colorCode: 'st_silver' },
							{ name: '<span class="lang_kz">жасыл</span><span class="lang_ru">зеленый</span>', colorChip: 'color_02st_green.png', colorCode: 'st_green' },
						],
					},
					{
						name: "<span class='lang_kz'>Сұрғылт шыны</span><span class='lang_ru'>Дымчатое стекло</span>",
						colors: [
							{ name: '<span class="lang_kz">сұрғылт сарғыш</span><span class="lang_ru">дымчатый бежевый</span>', colorChip: 'color_03mg_beige.png', colorCode: 'mg_beige' },
							{ name: '<span class="lang_kz">сұрғылт қызғылт</span><span class="lang_ru">дымчатый розовый</span>', colorChip: 'color_03mg_pink.png', colorCode: 'mg_pink' },
							{ name: '<span class="lang_kz">сұрғылт жалбыз түстес </span><span class="lang_ru">дымчатый мятный</span>', colorChip: 'color_03mg_mint.png', colorCode: 'mg_mint' },
							{ name: '<span class="lang_kz">сұрғылт күміс түстес</span><span class="lang_ru">дымчатый серебристый</span>', colorChip: 'color_03mg_silver.png', colorCode: 'mg_silver' },
						],
					},
					{
						name: '<span class=\'lang_kz\'>Nature</span><span class=\'lang_ru\'>Nature</span>',
						colors: [
							{ name: '<span class="lang_kz">Nature<br />Black</span><span class="lang_ru">Nature<br />Black</span>', colorChip: 'color_04nm_black.png', colorCode: 'nm_black' },
						],
					}
					/*{ name : '네이쳐',
						colors : [
			...
			{
				id: 'refrigerator_bottomFreezer',
				name: 'Bottom Freezer',
				icon: { default: 'Thumb_09.png', focus: 'Thumb_09_selected.png' },
				offset: { top: 327, left: 539, },
				size: { width: 145, height: 492, },
				selectedImage: 'appliances/rf_bf/rf_bf_selected.png',
				slideIndex: 0,
				shop_link: 'https://lgobjetcollection.co.kr/',
				spotButton: {
					offset: { top: 12, left: 12, },
				...
				selections: [ // 가전 별 선택 가능한 영역
					{
						id: 'refrigerator_bottomFreezer_T',
						offset: { top: 327, left: 539, },
						size: { width: 144, height: 299, },
						placeholder: 'appliances/rf_bf/rf_bf_door01_nomal.png',
						defaultImage: 'appliances/rf_bf/rf_bf_door01_nomal.png', //첫 오브제 기기 init 시 보여줄 selection 이미지
						Surface: [
							{ colorCode: 'mg_beige', filename: 'appliances/rf_bf/rf_bf_door01_03mg_beige.png' },
							{ colorCode: 'mg_pink', filename: 'appliances/rf_bf/rf_bf_door01_03mg_pink.png' },
							{ colorCode: 'mg_mint', filename: 'appliances/rf_bf/rf_bf_door01_03mg_mint.png' },
							{ colorCode: 'mg_silver', filename: 'appliances/rf_bf/rf_bf_door01_03mg_silver.png' },
							{ colorCode: 'nm_black', filename: 'appliances/rf_bf/rf_bf_door01_04nm_black.png' },
						],
					},
					{
						id: 'refrigerator_bottomFreezer_M',
						offset: { top: 636, left: 539, },
						size: { width: 144, height: 186, },
						placeholder: 'appliances/rf_bf/rf_bf_door02_nomal.png',
						defaultImage: 'appliances/rf_bf/rf_bf_door02_nomal.png',
						Surface: [
							{ colorCode: 'mg_beige', filename: 'appliances/rf_bf/rf_bf_door02_03mg_beige.png' },
							{ colorCode: 'mg_pink', filename: 'appliances/rf_bf/rf_bf_door02_03mg_pink.png' },
							{ colorCode: 'mg_mint', filename: 'appliances/rf_bf/rf_bf_door02_03mg_mint.png' },
							{ colorCode: 'mg_silver', filename: 'appliances/rf_bf/rf_bf_door02_03mg_silver.png' },
							{ colorCode: 'nm_black', filename: 'appliances/rf_bf/rf_bf_door02_04nm_black.png' },
						],
					}
				],
				supportedSurface: [   //지원 가능한 색상 정보, sidebar 에서 활용
				...
				selections: [
					{
						...
						Surface: [
							...
							{ colorCode: 'mg_beige', filename: 'appliances/oven/oven_03mg_beige.png' },
						],
					},
				],
				supportedSurface: [
			...
			},*/
			{
				...
				supportedSurface: [
					{
						name: "<span class='lang_kz'>Өңделмеген металл</span><span class='lang_ru'>Необработанный металл</span>",
						colors: [
			...
			},
			{
				...
				offset: { top: 310, left: 5049, },
				size: { width: 156, height: 507, },
				...
				supportedSurface: [
					{
						name: "<span class='lang_kz'>Сұрғылт шыны</span><span class='lang_ru'>Дымчатое стекло</span>",
						colors: [
							{ name: '<span class="lang_kz">сұрғылт жасыл</span><span class="lang_ru">дымчатый зеленый</span>', colorChip: 'color_03mg_green.png', colorCode: 'mg_green' },
							{ name: '<span class="lang_kz">сұрғылт сарғыш</span><span class="lang_ru">дымчатый бежевый</span>', colorChip: 'color_03mg_beige.png', colorCode: 'mg_beige' },
						],
					},
				],
			},
			{
				...
				icon: { default: 'Thumb_09.png', focus: 'Thumb_09_selected.png' },
				offset: { top: 549, left: 5951, },
				size: { width: 83, height: 331, },
				...
				supportedSurface: [
					{
						name: "<span class='lang_kz'>Тыныштандыратын</span><span class='lang_ru'>Успокаивающий</span>",
						colors: [
							{ name: 'зеленый', colorChip: 'color-04-calm-green.png', colorCode: 'calm_green' },
							{ name: '<span class="lang_kz">сарғыш</span><span class="lang_ru">бежевый</span>', colorChip: 'color-04-calm-beige.png', colorCode: 'calm_beige' },
						],
					},
				],
			},
			{
				 ...
				 offset :    { top : 146, left : 6423, },
				 size :      { width : 378, height : 130, },
				 ...
				 selections : [
					  {
							...
							Surface : [
								 {colorCode : 'calm_beige', filename : 'appliances/aircon/ac_05ca_beige.png'},
								 {colorCode : 'calm_green', filename : 'appliances/aircon/ac_05ca_green.png'},
							],
					  },
				 ],
				 supportedSurface : [
					...
					for (var i = 0; i < tmpObject.length; i++) {
						tmpObject[i].addEventListener('click', function () {
							if (this.checked) {
								...
								//@2022-06-10 제품 클릭시 Coming Soom 문구 팝업 (s)
								if (this.value == "styler" || this.value == "refrigerator_bottomFreezer" || this.value == "aircon") {
									noSale();
									simulator.hideRightSideOptions();
								}
								//@2022-06-10 제품 클릭시 Coming Soom 문구 팝업 (e)
			...
			for (var i = 0; i < arraySelectedSurface.length; i++) {
				...
				for (var j = 0; j < arraySelectedSurface[i].colors.length; j++) {
					...
					outputHtml += '<li>' +
						...
						'data-color-code="' + arraySelectedSurface[i].colors[j].colorCode + '" data-target-object="' + targetId + '" data-object-id="' + ID + '" data-link-name="' + slideLocation + '-' + arraySelectedName + '-' + arraySelectedSurface[i].colors[j].colorCode + '">' +
