...
$(".btn-style").on("click", function () {
	...
	$("#objet_select_slider .swiper-slide").each(function (idx) {
		...
		let bgUrlFront = "https://www.lg.com/au/images/objet/simulator/bg/";
...
function tooltipOpen(e) {
	...
	if (thisA == "FENIX") {
		...
		var img = "<img src='https://www.lg.com/au/images/objet/img-fenix.jpg' />";
		...
		var img = "<img src='https://www.lg.com/au/images/objet/img-Calming.jpg' />";
		...
		var img = "<img src='https://www.lg.com/au/images/objet/img-Solid.jpg' />";
		...
		var img = "<img src='https://www.lg.com/au/images/objet/img-Mist.jpg' />";
		...
		var img = "<img src='https://www.lg.com/au/images/objet/img-Nature.jpg' />";
	}
...
$("#save").on("click", function () {
	...
	if ($("#refrigerator_convertible_L").val() != "" || $("#refrigerator_convertible_M").val() != "" || ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") /*|| ($("#wash_T").val() != "" && $("#wash_B").val() != "") || $("#clean").val() != "" *//*|| $("#styler").val() != "" */) {
		let popCont = '';
		let imgUrl = 'https://www.lg.com/au/images/objet/simulator/appliances/';
		if ($("#refrigerator_convertible_L").val() != "") {//Fridge
			let nm = "rf_con";
			let nmTxt = "larder";
			...
			popCont += '		<img src="' + mixNm + '" alt="Fridge" />';
			//popCont += '		<span class="nm">'+nmTxt+'</span>';
			popCont += '	</div>';
			/* 220607 start */
			popCont += '	<span class="tit_txt">Fridge <em>*Coming soon</em></span>';
			/* 220607 end */
			...
			/* 220603 start */
			// popCont += '	<button type="button" class="btn_cta" id="ComingSoonBtn">Add To Cart</button>';
			popCont += '	<a class="btn_cta" href="https://www.lg.com/au/objet-collection/lg-mp-l386">Learn More</a>';
			/* 220603 end */
		...
		if ($("#refrigerator_convertible_M").val() != "") {//freezer
			...
			popCont += '	</div>';
			/* 220603 start */
			popCont += '	<span class="tit_txt">Freezer <em>*Coming soon</em></span>';
			/* 220603 end */
			...
			/* 220603 start */
			// popCont += '	<button type="button" class="btn_cta" id="ComingSoonBtn">Add To Cart</button>';
			popCont += '	<a class="btn_cta" href="https://www.lg.com/au/freezers/lg-mp-f324">Learn More</a>';
			/* 220603 end */
			//@2022-05-18 장바구니 CTA 버튼추가 및 PDP 버튼 숨김처리 (e)
		...
		if ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") {//상냉장고
			...
			/* 220607-2 start */
			popCont += '	<span class="tit_txt">French Door Fridge</span>';
			/* 220607-2 end */
...
$("body").on("click", ".btn_cta", function () {
	...
	var _splitUrl = currentUrl.split('/');

	if(_splitUrl[2] === "www.lg.com"){
		ajaxUrl = "https://www.lg.com/au/shop/graphql"
	}else{
		ajaxUrl = "https://wwwstg.lg.com/au/shop/graphql"
	}
...
$(".btn-close").on("click", function () {
	...
	// $(".coming_soon_modal").removeClass("show");
});
// Coming Soon 
/* $(document).on("click", "#ComingSoonBtn", function () {
	$(".coming_soon_modal").addClass("show");
