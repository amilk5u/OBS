...
$("body").on("click", ".btn_cta", function () {
	...
	var basketUrl = $(".basket_modal").find(".btn-primary");

	if(_splitUrl[2] === "www.lg.com"){
		ajaxUrl = "https://www.lg.com/au/shop/graphql";
		basketUrl.attr("href","https://www.lg.com/au/shop/checkout/cart/");
	}else{
		ajaxUrl = "https://wwwstg.lg.com/au/shop/graphql";
		basketUrl.attr("href","https://wwwstg.lg.com/au/shop/checkout/cart/");
	}
	/* 220607 end */
