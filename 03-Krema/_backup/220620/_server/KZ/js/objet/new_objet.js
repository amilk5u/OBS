...
(function($) {
    ...
    $(".style_select_area .style_list ul li button").on("click",function(){
        ...
        $("#objet_select_slider .swiper-slide").each(function(idx){
            ...
            let imgName = "bg_"+styleId+"_B_0";
            $(this).find(">img").attr("src",$(this).find(">img").attr("src").replace("bg_modern_B_0",imgName));
    ...
    //back to innerSimulatorPrev
    $("#backToInnerSimulatorPrev").on("click",function(){
        $(".simul_open").removeClass("simul_open");
        $(".simulator_area").css({"opacity":"","z-index":""});
        $("#simulator_dw").css("display","none");
        $(".type02 .objet-bx ul li .btn-style").removeClass("active");
        $(".select_objet.active").removeClass("active");
        $(".objet input[name=objet-selected]").prop('checked',false);
    });
    ...
    $(".choice_lang > button").on("click",function(){
        if($(this).hasClass("set_kz")){
            $(".set_ru").removeClass("is_active");
            $(this).addClass("is_active");
            $("body").removeClass("set_lang_ru").addClass("set_lang_kz");
        }else{
            $(".set_kz").removeClass("is_active");
            $(this).addClass("is_active");
            $("body").removeClass("set_lang_kz").addClass("set_lang_ru");
        }
    });
