...
$("#save").on("click", function () {
	...
	if ( $("#refrigerator_convertible_L").val() != "" || $("#refrigerator_convertible_M").val() != "" || ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") || $("#oven").val() != "" || ($("#wash_T").val() != "" && $("#wash_B").val() != "") || $("#clean").val() != "" /*|| $("#styler").val() != ""*/  /*|| ( $("#refrigerator_bottomFreezer_T").val() != "" && $("#refrigerator_bottomFreezer_M").val() != "" )*/ /*|| $("#aircon").val() != ""*/ ) {
		let popCont = '';
		...
		if ($("#refrigerator_convertible_L").val() != "") {//larder
			...
			let mixNm = imgUrl + nm + "/ico/rf_con_default.png";
			let tarLinkA = 'https://www.lg.com/kz/refrigerators/lg-gc-b401fepm';
			let tarLinkF = 'https://www.lg.com/kz/refrigerators/lg-gc-b404feqm';
			let arLink = 'https://lgarexperience.com/ha/objet/onedoor/gb';
			let target = 'target="_blank"';
			if (colorNm == "mg_silver") {
				mixNm = imgUrl + nm + "/ico/" + nm + "_" + colorNm + ".png";
		...
		if ($("#refrigerator_bottomFreezer_T").val() != "" && $("#refrigerator_bottomFreezer_M").val() != "" ) {//바텀프리저
			let nm = "rf_bf";
			...
			if(colorNmT == 'mg_silver' && colorNmM == 'mg_silver' || colorNmT == 'nm_black' && colorNmM == 'nm_black'){
				mixNm = imgUrl + nm + "/ico/" + nm + "_" + colorNmT + ".png";
			}
			popCont += '';
			popCont += '<li>';
			popCont += '	<div class="pic_box">';
			...
			popCont += '	</div>';
			popCont += '	<a href="' + tarLink + '" ' + target + ' class="go_detail" data-link-name="move to Bottom Freezer Толығырақ"><span>Толығырақ</span></a>';
			popCont += '</li>';
		}
		...
		if ($("#oven").val() != "") {//오븐
			let nm = "oven";
			let nmTxt = "oven";
			let colorNm = $("#oven").val();
			let mixNm = imgUrl + nm + "/ico/oven_default.png";
			let tarLink = 'javascript:noSale();';
			let arLink = '';
			let target = '';
			// let target = 'target="_blank"';
			...
			popCont += '<li>';
			popCont += '	<div class="pic_box">';
			// popCont += '		<a href="' + arLink + '" target="_blank" class="go_ar" data-link-name="move to oven ar"></a>';
			popCont += '		<img src="' + mixNm + '" alt="" class="oven" />';
			popCont += '	</div>';
			popCont += '	<a href="' + tarLink + '" ' + target + ' class="go_detail" data-link-name="move to oven Толығырақ"><span>Толығырақ</span></a>';
			popCont += '</li>';
		}
		...
		if ($("#wash_T").val() != "" && $("#wash_B").val() != "") {//워시타워
			...
			let tarLink = 'https://www.lg.com/kz/washing-machines/lg-w1s1cvkk2hm';
			let arLink = 'https://lgarexperience.com/ha/objet/washtower/gb';
			let target = 'target="_blank"';
			popCont += '';
			popCont += '<li>';
			popCont += '	<div class="pic_box">';
		...
		if ($("#clean").val() != "") {//청소기
			...
			let mixNm = imgUrl + nm + "/ico/clean_default.png";
			let tarLink = 'https://www.lg.com/kz/vacuum-cleaners/lg-a9t-ultra2';
			let arLink = 'https://lgarexperience.com/ha/objet/allinonetower/beige';
			let target = 'target="_blank"';
			popCont += '';
			popCont += '<li>';
			popCont += '	<div class="pic_box">';
		...
		if($("#styler").val() != ""){//스타일러
			 ...
			 let mixNm = imgUrl + nm + "/ico/styler_default.png";
			 let tarLink = 'javascript:noSale();';
			 let arLink = 'https://lgarexperience.com/ha/objet/styler/beige';
			 let target = '';
			 if (colorNm == "mg_green") {
			 ...
			 popCont += '	</div>';
			 popCont += '	<a href="'+tarLink+'" ' + target + ' class="go_detail" data-link-name="move to styler Подробнее"><span>Подробнее</span></a>';
			 popCont += '</li>';
		}
		...
		if ($("#aircon").val() != "") {//아트쿨
			let nm = "aircon";
			let nmTxt = "aircon";
			let colorNm = $("#aircon").val();
			let mixNm = imgUrl + nm + "/ico/aircon_default.png";
			let tarLink = 'javascript:noSale();';
			let arLink = 'javascript:noSale();';
			let target = '';
			...
			popCont += '<li>';
			popCont += '	<div class="pic_box">';
			// popCont += '		<a href="' + arLink + '" target="_blank" ' class="go_ar" data-link-name="move to aircon ar"></a>';
			popCont += '		<img src="' + mixNm + '" alt="" class="aircon" />';
			popCont += '	</div>';
			popCont += '	<a href="' + tarLink + '" ' + target + ' class="go_detail" data-link-name="move to aircon Толығырақ"><span>Толығырақ</span></a>';
			popCont += '</li>';
		}
