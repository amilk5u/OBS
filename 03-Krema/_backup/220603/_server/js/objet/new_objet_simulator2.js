...
$(".btn-style").on("click", function () {
	...
	$("#objet_select_slider .swiper-slide").each(function (idx) {
		...
		/* CMS 업로드시 수정필요 */
		// let bgUrlFront = "/au/https://www.lg.com/au/images/objet/simulator/bg/";
...
function tooltipOpen(e) {
	...
	if (thisA == "FENIX") {
		...
		/* CMS 업로드시 수정필요 */
		// var img = "<img src='/au/https://www.lg.com/au/images/objet/img-fenix.jpg' />";
		...
		/* CMS 업로드시 수정필요 */
		// var img = "<img src='/au/https://www.lg.com/au/images/objet/img-Calming.jpg' />";
		...
		/* CMS 업로드시 수정필요 */
		// var img = "<img src='/au/https://www.lg.com/au/images/objet/img-Solid.jpg' />";
		...
		/* CMS 업로드시 수정필요 */
		// var img = "<img src='/au/https://www.lg.com/au/images/objet/img-Mist.jpg' />";
		...
		/* CMS 업로드시 수정필요 */
		// var img = "<img src='/au/https://www.lg.com/au/images/objet/img-Nature.jpg' />";
...
$("#save").on("click", function () {
	...
	if ($("#refrigerator_convertible_L").val() != "" || $("#refrigerator_convertible_M").val() != "" || ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") /*|| ($("#wash_T").val() != "" && $("#wash_B").val() != "") || $("#clean").val() != "" *//*|| $("#styler").val() != "" */) {
		...
		if ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") {//상냉장고
			...
			//ex) https://www.lg.com/au/images/objet/simulator/appliances/rf/ico/rf_st_green_st_silver_st_silver.png
...
$("body").on("click", ".btn_cta", function () {
	...
	if ($objetId == "refrigerator") {
		...
		$.ajax({
			url: 'https://krema0515.com/resources/test/2022/objetCollection/AU/js/objet/graphql',
			method: "POST",
			timeout: 0,
			headers: {
				"Store": "au",
