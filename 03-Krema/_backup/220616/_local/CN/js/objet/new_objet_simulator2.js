...
$("#save").on("click", function () {
    ...
    if ($("#refrigerator_convertible_L").val() != "" || $("#refrigerator_convertible_M").val() != "" || ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") || ($("#wash_T").val() != "" && $("#wash_B").val() != "") || $("#clean").val() != "" || $("#styler").val() != "" || ($("#refrigerator_bottomFreezer_T").val() != "" && $("#refrigerator_bottomFreezer_M").val() != "")) {
        ...
        if ($("#refrigerator_convertible_L").val() != "") {//larder
			...
			let tarLinkA = "https://www.lg.com/cn/refrigerators/lg-a381be";
			let tarLinkF = "https://www.lg.com/cn/refrigerators/lg-f381be";
        ...
        if ($("#wash_T").val() != "" && $("#wash_B").val() != "") {//워시타워
            ...
            popCont += '		<img src="' + mixNm + '" alt="wash" class="wash" />';
            popCont += '	</div>';
        ...
        if ($("#clean").val() != "") {//청소기
            ...
            let tarLink = 'https://www.lg.com/cn/vacuum-cleaners/lg-a9t-ultra';
        ...
        if ($("#styler").val() != "") {//스타일러
			...
			let tarLink = "https://www.lg.com/cn/styler/lg-s5goc";
			let arLink = "https://lgarexperience.com/ha/objet/styler/green";
			let target = 'target="_blank"';
            if (colorNm == "mg_beige") {
				mixNm = imgUrl + nm + "/ico/" + nm + "_" + colorNm + ".png";
