...
function tooltipOpen(e) {
    ...
    if ( thisA == "FENIX" ) {
        ...
        var img = "<img src='/cn/images/objet/img-fenix.jpg' />";
    } else if ( thisA == "平静" ) {
        var title = "平静";
        var ptext = "坚固且不失轻巧，搭配独特的透明度和光滑的表面，可以打造出整洁、干净且沉稳的空间。";
        var img = "<img src='/cn/images/objet/img-Calming.jpg' />";
    }else if ( thisA == "固态金属" ) {
        var title = "固态金属";
        var ptext = "哑光不锈钢的表面素雅精致，展现了金属材质与生俱来的精美时尚，适合打造既现代又美丽的空间。";
        var img = "<img src='/cn/images/objet/img-Solid.jpg' />";
    }else if ( thisA == "专属打造" ) {
        var title = "专属打造";
        var ptext = "哑光玻璃材质具有薄雾般的柔和触感，能够淡雅地融入室内空间。";
        var img = "<img src='/cn/images/objet/img-Mist.jpg' />";
    }else if ( thisA == "天然金属" ) {
        var title = "天然金属";
        var ptext = "这是一款具有自然质感的金属材料，无论用于何种类型的空间，都能营造出一种平静放松的氛围。";
        var img = "<img src='/cn/images/objet/img-Nature.jpg' />";
    }
...
$("#save").on("click", function(){
    ...
    if($("#refrigerator_convertible_L").val() != "" || $("#refrigerator_convertible_M").val() != "" ||  ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") || ($("#wash_T").val() != "" && $("#wash_B").val() != "") || $("#clean").val() != "" || $("#styler").val() != "" ){
        ...
        if($("#refrigerator_convertible_L").val() != ""){//larder
            ...
            popCont += '	<a href="'+tarLink+'" '+target+' class="go_detail" data-link-name="move to 冰箱 阅读更多"><span>冰箱</span></a>';
            popCont += '</li>';
        }
        ...
        if($("#styler").val() != ""){//스타일러
            ...
            popCont += '	</div>';
            popCont += '	<a href="'+tarLink+'" target="_blank" class="go_detail" data-link-name="move to styler 阅读更多"><span>阅读更多</span></a>';
            popCont += '</li>';
        }
