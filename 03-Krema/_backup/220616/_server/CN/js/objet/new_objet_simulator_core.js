...
(function(objSimulator){
    ...
    /*var backgroundImageURL = 'https://www.lg.com/cn/images/objet/simulator/bg/', //배경 이미지 저장경로
        objectImageURL = 'https://www.lg.com/cn/images/objet/simulator/'; //오브제 이미지 저장경로*/
    ...
    var configData = { //환경 설정값 저장, JSON 정상 로딩 시 override 됨
        ...
        backgroundImages : [
            ...
            {
                name : 'modern',
                images : ['bg_modern_B_01.png', 'bg_modern_B_02.png', 'bg_modern_B_03.png'/*, 'bg_modern_04.jpg'*/]
            },
            {   name : 'nature',
                images : ['bg_nature_B_01.png', 'bg_nature_B_02.png', 'bg_nature_B_03.png'/*, 'bg_nature_04.jpg'*/]
            },
            {   name : 'nordic',
                images : ['bg_nordic_B_01.png', 'bg_nordic_B_02.png', 'bg_nordic_B_03.png'/*, 'bg_nordic_04.jpg'*/]
            }
        ...
        object : [
            {
                ...
                supportedSurface : [   //지원 가능한 색상 정보, sidebar 에서 활용
                    ...
                    { name : '固态金属',
                        colors : [
                            // { name : '曼哈顿午夜黑', colorChip : 'color_02st_black.png', colorCode : 'st_black'},
                            { name : '流光银', colorChip : 'color_02st_silver.png', colorCode : 'st_silver'},
                            { name : '墨玉绿', colorChip : 'color_02st_green.png', colorCode : 'st_green'},
                        ],
                    },
                    { name : '专属打造',
                        colors : [
                            { name : '玉石白', colorChip : 'color_03mg_beige.png', colorCode : 'mg_beige'},
                            { name : '粉黛色', colorChip : 'color_03mg_pink.png', colorCode : 'mg_pink'},
                            { name : '薄荷绿', colorChip : 'color_03mg_mint.png', colorCode : 'mg_mint'},
                            { name : '流光银', colorChip : 'color_03mg_silver.png', colorCode : 'mg_silver'},
                        ],
                    },
                    {
                        name: 'Nature',
                        colors: [
                            { name: 'Nature<br />Black', colorChip: 'color_04nm_black.png', colorCode: 'nm_black' },
                        ],
                    }
                    /*{ name : '네이쳐',
                        colors : [
            ...
            },*/
            {
                ...
                supportedSurface : [
                    { name : '天然金属',
                        colors : [
                            { name : '墨玉绿', colorChip : 'color_04nm_green.png', colorCode : 'nm_green'},
                            { name : '玉石白', colorChip : 'color_04nm_beige.png', colorCode : 'nm_beige'},
            ...
            },
            {
                ...
                supportedSurface : [
                    { name : '平静',
                        colors : [
                            { name : '墨玉绿', colorChip : 'color-04-calm-green.png', colorCode : 'calm_green'},
                            { name : '玉石白', colorChip : 'color-04-calm-beige.png', colorCode : 'calm_beige'},
                        ],
                    },
                ],
            },
            {
                ...
                supportedSurface : [
                    { name : '专属打造',
                        colors : [
                            { name : '墨玉绿', colorChip : 'color_03mg_green.png', colorCode : 'mg_green'},
                            { name : '玉石白', colorChip : 'color_03mg_beige.png', colorCode : 'mg_beige'},
                        ],
                    },
                ],
