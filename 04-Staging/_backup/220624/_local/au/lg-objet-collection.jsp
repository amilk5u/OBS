				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<a href="https://www.lg.com/au/shop/checkout/cart/" class="btn btn-primary">View Cart</a>
						</div>
						<div class="simple-content-box">
								...
								<div class="inner_wrap">
									...
									<div class="faq_cont">
										<dl>
											...
											<dd>
												<p class="answer">
													...
													<span>For any queries including orders, specific requirements and indicative delivery timeframes, please contact LG Customer Care:</span>
													<span class="in_desc">
														...
														<span> Telephone : <em>1300 54 22 73 (Monday to Sunday 8 am to 8pm AEST)</em></span>
													</span>
												</p>
											</dd>
										</dl>
										<dl>
											...
											<dd>
												<p class="answer">
													<span>For purchase/stock enquiries and after purchase enquiries (repair, colour change, etc), please contact LG Customer Care:</span>
													<span class="in_desc">
														<span> Email : <em><a href="mailto:obsanz@lge.com">obsanz@lge.com</a></em></span>
														<span> Live Chat : <em><a href="https://www.lg.com/au/support/chat-email" target="_blank" title="https://www.lg.com/au/support/chat-email">https://www.lg.com/au/support/chat-email</a></em> </span>
														<span> Telephone : <em>1300 54 22 73 (Monday to Sunday 8 am to 8pm AEST)</em></span>
										...
										<dl>
											<dt>
												<button type="button">
													<p>Can I mix and match the Stainless Steel and Mist Glass finishes?</p>
												</button>
											</dt>
											<dd>
										...
										<dl>
											<dt>
												<button type="button">
													<p>How many different coloured panels can I order for a French Door Fridge?</p>
												</button>
											</dt>
											<dd>
												<p class="answer">There are total 7 colours available. 3 Colours for Stainless Finish and 4 Colours for Mist Glass.</p>
											</dd>
										</dl>
										<dl>
											<dt>
												<button type="button">
													<p>Can I change my mind and change the colour panels selected after purchase?</p>
												</button>
											</dt>
											<dd>
												<p class="answer">If you change your mind after purchase, please refer to the ‘Change of mind’ condition from LG Terms and Conditions of Sale available at <a href="https://www.lg.com/au/terms-and-conditions-of-sale">https://www.lg.com/au/terms-and-conditions-of-sale</a> for cancelation windows and ‘Change of mind’ policy.</p>
											</dd>
										</dl>
										<dl>
											<dt>
												<button type="button">
													<p>How do I ‘fit’ my interchangeable colour panels? Can I change the panels myself?</p>
												</button>
											</dt>
											<dd>
												<p class="answer">
										...
										<dl>
											<dt>
												<button type="button">
													<p>What is the cost for new colour panels and for a panel fit service?</p>
												</button>
											</dt>
											<dd>
												<p class="answer">
										...
										<dl>
											<dt>
												<button type="button">
													<p>Can I get a colour sample / swatch of the interchangeable colour panels prior to purchase?</p>
												</button>
											</dt>
											<dd>
												<p class="answer">
										...
										<dl>
											<dt>
												<button type="button">
													<p>What are the Pantone colours for the interchangeable colour panels?</p>
												</button>
											</dt>
											<dd>
												<p class="answer">
										...
										<dl>
											...
											<dd>
												<p class="answer">
													<span>No, InstaView™ glass panel is fixed and cannot be disassembled and replaced.</span>
												</p>
											</dd>
										</dl>
										<dl>
