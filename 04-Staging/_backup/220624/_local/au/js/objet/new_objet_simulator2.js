...
$("#save").on("click", function () {
	...
	if ($("#refrigerator_convertible_L").val() != "" || $("#refrigerator_convertible_M").val() != "" || ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") /*|| ($("#wash_T").val() != "" && $("#wash_B").val() != "") || $("#clean").val() != "" *//*|| $("#styler").val() != "" */) {
		...
		if ($("#refrigerator_convertible_L").val() != "") {//Fridge
			...
			popCont += '	</div>';
			/* @2022-06-09 제품 타이틀 변경 (s) */
			popCont += '	<span class="tit_txt">Single Door Fridge<em>*Coming soon</em></span>';
			/* @2022-06-09 제품 타이틀 변경 (e) */
		...
		if ($("#refrigerator_convertible_M").val() != "") {//freezer
			...
			popCont += '	</div>';
			/* @2022-06-09 제품 타이틀 변경 (s) */
			popCont += '	<span class="tit_txt">Upright Freezer<em>*Coming soon</em></span>';
			/* @2022-06-09 제품 타이틀 변경 (e) */
...
$("body").on("click", ".btn_modelRestBtn", function () {
	...
	//  console.log("ajaxUrl:",ajaxUrl,"basketUrl:",basketUrl);
