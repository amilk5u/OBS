...
(function ($) {
	...
	$(".next_arr_wrap button").on("click", function () {
      ...
      if(idx != 2){
         ...
         var prdH = $("#innerSimulatorPrev").outerHeight() + $("#innerVideo").outerHeight();
         goSlideIdx(1, 200);
   ...
   $(".style_select_area .style_list ul li button").on("click", function () {
	...
	$(".objet_slide_cont:last-child").on("scroll", function () {//피럴럭스 효과 추가
		...
		if (scTop > sumContHArry[2]) {
			$(this).find(".inner_contents:eq(" + 3 + ")").addClass("is_active");
		}
		/* @2022-06-07 비디오, 시뮬 순서변경 (e) */
	...
	$(".objetcollection-tabs .tabs button").on("click", function () {
		...
		if (naviIdx == "0") {
         ...
         goSlideIdx(1, 200);
         $(".objet_slide_cont:last-child").animate({ "scrollTop": naviH[2] }, 1000);
      } else if (naviIdx == "5") {
         goSlideIdx(1, 200);
         $(".objet_slide_cont:last-child").animate({ "scrollTop": naviH[3] + 10 }, 1000);
      } else if (naviIdx == "6") {
         goSlideIdx(1, 200);
         $(".objet_slide_cont:last-child").animate({ "scrollTop": naviH[4] + 10 }, 1000);
      }
		/* @2022-06-07 비디오, 시뮬 순서변경 (e) */
	...
	$(".objet_slide_cont:last-child").on("scroll", function () {
		if ($(".objet_slide_cont[data-cont-idx=2]").hasClass("is_active")) {
            ...
            $(".objetcollection-tabs .tabs li:eq(1)").siblings().removeClass("on");
            $(".objetcollection-tabs .tabs li:eq(1)").addClass("on");
