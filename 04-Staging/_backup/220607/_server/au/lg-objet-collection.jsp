						...
						<div class="cont_inner">
							<div class="video_area only_pc">
								<video autoplay="" controls playsinline="" muted="">
									<source src="/au/images/objet/img-main-05.mp4" type="video/mp4">
									<p></p>
								</video>
							</div>
							<div class="video_area only_mobile">
								<video autoplay="" controls playsinline="" muted="">
									<source src="/au/images/objet/img-main-05_m.mp4" type="video/mp4">
									<p></p>
								</video>
							</div>
							<div class="next_arr_wrap">
					...
					<div data-cont-idx="2" class="objet_slide_cont">
						<div class="cont_inner">
							...
							<div id="innerSimulatorPrev" class="inner_contents">
								<div class="title">
									<!-- @22-06-03 Collection 타이틀 수정 (s) -->
									<h2>Make it your own <br>with LG Objet® Collection</h2>
									<!-- @22-06-03 Collection 타이틀 수정 (e) -->
