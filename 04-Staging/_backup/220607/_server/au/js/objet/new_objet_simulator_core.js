				 ...
				 if (window.Scrollbar.has(targetSideBarArea)) {
					 ...
					 if (ID === "refrigerator_convertible") {
						 ...
						 if (targetID === 'refrigerator_convertible_L') {
							 ...
							 collectionHtml += '<div class="btn_wrap"> <a href="https://www.lg.com/au/objet-collection/lg-mp-l386">Find out more</a></div> </div></div>';
							 collectionHtml += '</div>';
						 }
						 if (targetID === 'refrigerator_convertible_M') {
							 ...
							 collectionHtml += '<div class="btn_wrap"> <a href="https://www.lg.com/au/freezers/lg-mp-f324">Find out more</a></div> </div></div>';
							 collectionHtml += '</div>';
						 }
					 }
