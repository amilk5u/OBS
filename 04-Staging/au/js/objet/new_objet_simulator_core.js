				...
				if (window.Scrollbar.has(targetSideBarArea)) {
					...
					if (ID === "refrigerator_convertible") {
						...
						if (targetID === 'refrigerator_convertible_L') {
							...
							collectionHtml += '<div class="txt_wrap"> <span>LG Objet Collection® Single Door Fridge</span> <p>386L Single Door Fridge w Interchangeable Panels in Silver Stainless Steel</p> <span class="price_num">' + model_price + '</span>';
						...
						if (targetID === 'refrigerator_convertible_M') {
							...
							collectionHtml += '<div class="txt_wrap"> <span>LG Objet Collection® Upright Freezer</span> <p>324L Upright Freezer w Interchangeable Panels in Silver Stainless Steel</p> <span class="price_num">' + model_price + '</span>';
